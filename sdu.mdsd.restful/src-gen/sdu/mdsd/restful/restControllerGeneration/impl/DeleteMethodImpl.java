 ...
 * </p>
 * <ul>
 *   <li>{@link sdu.mdsd.restful.restControllerGeneration.impl.DeleteMethodImpl#getEntityId <em>Entity Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeleteMethodImpl extends MethodTypeImpl implements DeleteMethod
{
  ...
  {
    return RestControllerGenerationPackage.Literals.DELETE_METHOD;
  }
    ...
    if (entityId != null && entityId.eIsProxy())
    {
      ...
      if (entityId != oldEntityId)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RestControllerGenerationPackage.DELETE_METHOD__ENTITY_ID, oldEntityId, entityId));
      }
    }
    return entityId;
  }
  ...
  public void setEntityId(Attribute newEntityId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RestControllerGenerationPackage.DELETE_METHOD__ENTITY_ID, oldEntityId, entityId));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RestControllerGenerationPackage.DELETE_METHOD__ENTITY_ID:
