...
public class RestControllerGenerationGenerator extends AbstractGenerator {
  ...
  protected CharSequence _generateControllerMethod(final DeleteMethod method, final Entity entity) {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("Service.Delete(new Delete");
    String _name = entity.getName();
    _builder.append(_name, "    ");
    _builder.append("Parameters");
    _builder.newLineIfNotEmpty();
  ...
  protected void _generateControllerParameters(final CreateMethod method, final Entity entity, final IFileSystemAccess2 fsa) {
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      for(final Attribute x : _filter) {
        {
          if (((method.getExclude() != null) && (!method.getExclude().getAttributes().contains(x)))) {
            _builder.append("\t\t");
            _builder.append("public ");
            CharSequence _generateAttributeType = this.generateAttributeType(x.getType());
            _builder.append(_generateAttributeType, "\t\t");
    ...
    }
    {
      ...
      for(final CreateMethodWith x_1 : _withEntity) {
        ...
        _builder.append(" ");
        String _name_6 = x_1.getReference().getReference().getName();
        _builder.append(_name_6, "\t\t");
        String _name_7 = x_1.getReference().getAttribute().getName();
