...
public class RestControllerGenerationParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RestControllerGenerationGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalFunctionAccess().getExternalFuncAssignment_1(), "rule__ExternalFunction__ExternalFuncAssignment_1");
			...
			builder.put(grammarAccess.getControllerAccess().getMethodsAssignment_4(), "rule__Controller__MethodsAssignment_4");
